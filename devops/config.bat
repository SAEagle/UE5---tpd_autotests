...
rem Project params
set ProjectRoot=C:\Jenkins\Jobs\UnrealTopDown\ue5---tpd_autotests
set ProjectPureName=UnrealTopDown
...
set OpenCCPCoveragPath=C:\Program Files\OpenCppCoverage\OpenCppCoverage.exe
